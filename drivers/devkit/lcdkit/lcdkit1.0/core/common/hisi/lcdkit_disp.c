...
static struct hisi_fb_panel_data lcdkit_data =
{
    ...
    .snd_mipi_clk_cmd_store = (void *)lcdkit_snd_mipi_clk_cmd_store,
    .esd_handle = lcdkit_esd_check,
    .set_display_region = lcdkit_set_display_region,
    .lcd_fps_scence_handle = lcdkit_fps_scence_handle,
    .lcd_fps_updt_handle = (void *)lcdkit_fps_updt_handle,
    .lcd_ce_mode_show = (void *)lcdkit_ce_mode_show,
    .lcd_ce_mode_store = (void *)lcdkit_ce_mode_store,
    .lcd_rgbw_set_func = (void *)lcdkit_rgbw_set_func,
    .lcd_hbm_set_func  = (void *)lcdkit_hbm_set_func,
    .snd_cmd_before_frame = lcdkit_snd_cmd_before_frame,
    .amoled_alpm_setting_store = lcdkit_aod_alpm_setting_store,
	.lcd_color_param_get_func = (void *)lcdkit_color_param_get_func,
